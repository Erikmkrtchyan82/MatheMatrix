...
public class SecondActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        row=getIntent().getIntExtra(InputMultySize.SECOND_ROW_SIZE,2);
        column=getIntent().getIntExtra(InputMultySize.SECOND_COLUMN_SIZE,2);
        firstMatrix=FirstActivity.matrix;
    ...
    public void draw(){
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent=new Intent(SecondActivity.this,AnswerActivity.class);
...
//        set.setHorizontalBias(button.getId(),0.75f);
